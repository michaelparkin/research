 ...
 *
 * es.bsc.ur4j.RandomGUID generates truly random GUIDs by using the system's
 ...
 *
 * ----> Security of es.bsc.ur4j.RandomGUID: <-----
 * es.bsc.ur4j.RandomGUID can be called one of two ways -- with the basic java Random
