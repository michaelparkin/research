...
If you'd like the visualisation in another format than png, you can edit the (obvious) part of the parser.rb script to  jpg, gif, svg or PostScript. Other formats are probably supported by dot too.
